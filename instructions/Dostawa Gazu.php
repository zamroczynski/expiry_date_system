        ...
        <main>
            <article>
                <div class="container-fluid">
                    <header>DOSTAWA GAZU</header>
                    <div class="row">
                        <div class="col-sm-12">
                            <ol style="font-size:18px; text-align:justify">
                                <li>Zablokuj dystrybutory gazu</li>
                                <li>Skasuj wszystkie transakcje z dystrybutorów od gazu</li>
                                <li>BOS -> Dokumenty -> Pozostałe Dokumenty -> Pomiary Kontrolne -> POMIAR LICZNIKÓW DYSTRYBUTORÓW</li>
                                <li>Odczyt->Tak->Zatwierdź->Wydruk</li>
                                <li>Przy zablokowanych dystrybutorach stawiamy pachołki, przyczepiamy kartkę "Przepraszamy, dostawa [...]"</li>
                                <li>Dajemy kierowcy klucz podpisany jako "Zlew paliw LPG"</li>
                                <li><img src="../img/manual/Dostawa Gazu/1.jpg" /></li>
                                <li>Ciąg dalszy nastąpi</li>
                            </ol>
